...
export default function Teste16() {
      ...
      <Prod>
        <div>
          ...
          {testeconcluido ? (
            ...
            <>
              <p>
                Agora você irá fazer o Teste 6, para avaliar o seu progresso ao
          ...
          <div>
            <Default>
              {!testeconcluido ? (
                <Link to="/avancado/teste6/avaliacao">INICIAR</Link>
              ) : (
                <Link to="/avancado/teste6/resultado">VER RESULTADO</Link>
              )}
            </Default>
          </div>
        </div>
