...
export default function Teste17() {
      ...
      <Prod>
        <div>
          ...
          {testeconcluido ? (
            ...
            <>
              <p>
                Agora você irá fazer o <strong>Teste 17</strong> para avaliar o seu progresso ao
                longo do curso.
              </p>
              <br />
          ...
          <div>
            <Default>
              {!testeconcluido ? (
                <Link to="/avancado/teste7/avaliacao">INICIAR</Link>
              ) : (
                <Link to="/avancado/teste7/resultado">VER RESULTADO</Link>
              )}
            </Default>
          </div>
        </div>
