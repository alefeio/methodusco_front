...
export default function Exerciciosavaliacao(props) {
  ...
  const texto2 = [
    ...
    },
    {
      ...
      p5:
        'No entanto, mesmo com o grande impulso do movimento a favor da autoestima - que não ficou restrito aos Estados Unidos, mas influenciou formas de pensar em quase todo o planeta -, dados científicos começaram a minar alguns de seus principais pressupostos e sustentações. Muitas pesquisas mostram que pouca gente sofre disso. Pelo contrário, a maioria de nós já se sente muito bem sobre si.',
    },
    {
      p1:
        'Em um estudo publicado em 1989, o psicólogo Roy F. Baumeister e seus colegas Dianne M. Tice e Debra G. Hutton, na época da Universidade Case Western Reserve, mostraram que, de maneira geral, a pontuação dos americanos em relação à autoconfiança está bem acima da média das escalas, do ponto que denota visão moderada ou digna a respeito de si.',
      p2:
    ...
    },
    {
      ...
      p5:
        'Da mesma maneira, fugimos do mal-estar para contornar o fracasso. Já que não podemos ser bons em tudo, tendemos a investir naquilo que nos garante mais "vitórias" - por exemplo, a vida acadêmica, os esportes ou a aparência. Essas contingências representam as áreas em que a autoestima está em xeque: a pessoa sente-se merecedora se atinge seus objetivos, ou fracassada se falha.',
    },
    {
      p1:
      ...
      p2:
        'Não é de estranhar, portanto, que pessoas que se tornam extremamente dedicadas em algumas áreas comecem a dominá-las, o que geralmente as leva a se esforçar cada vez mais. Uma de nós (Jennifer) e colegas apontaram que estudantes cuja autoestima dependia de um retorno de desempenho estudavam mais do que os outros que não se apoiavam nesse campo.',
      p3:
        'Por outro lado, depender de realizações para sentir autoconfiança abre espaço para vulnerabilidade emocional e retrocessos. Mesmo pessoas bem-sucedidas, por mais que se esforcem, às vezes falham ou deixam a desejar. E, nessas ocasiões, a sensação de fracasso por golpes na autoestima parece ser muito maior do que os efeitos positivos decorrentes do sucesso. ',
      p4:
        'Em um estudo publicado em 2002, solicitamos a 37 universitários do último período, candidatos a pós-graduação, que preenchessem um questionário para avaliar o quanto baseavam a autoestima no histórico acadêmico, na aparência física, no bom relacionamento com a família e com os amigos etc. Na sequência, os estudantes deveriam continuar registrando a sensação de autoconfiança duas vezes por semana, durante dois meses, nos quais participariam do processo de seleção. Descobrimos que aqueles cuja autoestima estava fortemente ligada ao desempenho acadêmico sentiram pouco aumento na autoconfiança nos dias em que se safam bem, mas uma grande queda na segurança nos dias de baixo desempenho.',
      p5:
        'Para essas pessoas, a dor do fracasso superou a alegria do sucesso. Aqueles que não dependiam do resultado para preservar a autoconfiança experimentaram claramente flutuações mais amenas: mostraram-se emocionalmente mais estáveis diante de resultados positivos ou negativos. Outros estudos demonstram vulnerabilidade semelhante em relação à aparência ou ao sucesso profissional.',
    },
    {
      p1:
      ...
      p2:
        'No caso dos candidatos à pós-graduação, por exemplo, observamos que as flutuações na autoestima experimentadas estavam associadas a distúrbios do apetite e do sono, a perda de motivação, a humor deprimido e a sentimentos de desesperança e impotência.',
      p3:
        'A dependência de bom desempenho para manter a autoestima não raro leva a evitar o fracasso em vez de buscar o sucesso - uma atitude que pode minar as chances de êxito. Para proteger a autoconfiança, surgem desculpas para o mau desempenho, como "não tentei o suficiente" ou "estava cansado, doente, chateado".',
      p4:
        'Para ter efeito, a explicação deve ser verossímil. Por exemplo, uma pessoa pode ficar acordada até tarde antes de fazer um teste para validar a afirmação de cansaço caso vá mal na prova; ou adiar os estudos até o último momento para alegar que não pôde se dedicar o suficiente.',
      p5:
        'Os psicólogos sociais Edward E. Jones, da Universidade de Princeton, e Steven Berglas da Faculdade de Medicina da Universidade Harvard, cunharam o termo "autossabotagem" para descrever o comportamento.',
    },
    {
      p1:
    ...
    },
    {
      ...
      p4:
        'Aqueles que desenvolveram postura mais compreensiva demonstraram maior receptividade às necessidades dos colegas de quarto (de acordo com a própria opinião e a do companheiro). Os colegas com quem os voluntários dividiam o ambiente perceberam a atitude e responderam positivamente, criando um ciclo que fortaleceu a relação entre os dois.',
    },
    {
      p1:
        'Curiosamente, quanto mais procuravam ser sensíveis ao outro, maior autoestima demonstravam de acordo com as avaliações. O sentimento de autoconfiança entre os colegas também ficou mais forte, sugerindo que se manter atento às demandas dos outros pode ser uma estratégia bastante eficaz para reforçar o sentimento de amor-próprio a longo prazo. Por outro lado, aqueles que se preocuparam excessivamente com a ideia que o companheiro fazia sobre si foram menos atentos aos colegas - um padrão de comportamento que colaborou para tornar mais frágil a autoestima de ambos.',
      p2:
        'Os pesquisadores acreditam que é possível fortalecer propositadamente a tolerância consigo mesmo e com os outros para que, nos momentos difíceis, o sentimento ajude a amenizar a sensação de fracasso. Pessoas compreensivas tendem a tratar a si mesmas com gentileza, assim como um amigo próximo faria. "Não se trata de assumir uma atitude de condescendência ou de desresponsabilização, mas sim de ser paciente com as próprias limitações e fazer consigo mesmo o pacto de se esforçar para mudar o que incomoda em vez de simplesmente se julgar e se desprezar", afirma o psicólogo Kristin Neff, professor da Universidade do Texas em Austin.',
      p3:
    ...
    {
      p1:
        'Os participantes do experimento se autoavaliaram mais positivamente que outros que se recordaram de um momento divertido ou leram sobre pessoas em situação de sofrimento.',
      p2:
        'Uma técnica chamada pelos cientistas de autodistanciamento também ajuda a reduzir a preocupação excessiva consigo e os problemas decorrentes dessa atitude. A estratégia propõe que a pessoa olhe para si como se fosse da perspectiva de um terceiro.',
      p3:
  ...
  const texto3 = [
    {
      ...
      p2:
        'Existem executivos que se revelam quando estão sob pressão. Outros simplesmente desaparecem.',
      p3:
        'Faz tempo que os teóricos da administração tentam explicar por que isso acontece, e, invariavelmente, chegam a respostas parciais, como cultura corporativa adequada, administração por objetivos, etc.',
      p4:
        'O problema de ver as coisas dessa maneira é que se considera as pessoas do pescoço para cima, vinculando o alto desempenho apenas à capacidade cognitiva. Mas, para ter uma performance plena e constante, é preciso associar corpo, mente e espírito. Chamamos a essa hierarquia de pirâmide de desempenho, em que cada um dos níveis influencia os demais. Essa visão surgiu na época em trabalhamos com atletas de primeira linha.',
      p5:
    ...
    },
    {
      ...
      p2:
        'A mesma lição se aplica aos atletas corporativos. Em geral, eles se desgastam demais mental e emocionalmente, mas muito pouco fisicamente. As duas formas de linearidade fazem mal para o desempenho.',
      p3:
    ...
    },
    {
      ...
      p3:
        'Os atletas têm inúmeros rituais que ajudam a restaurar a energia positiva. Não é nenhuma coincidência, por exemplo, que muitos deles ouçam música antes da competição. A música tem um efeito poderoso sobre as condições fisiológicas e emocionais, e pode detonar um deslocamento na atividade mental do hemisfério esquerdo do cérebro, ligado à racionalidade, para o hemisfério direito, relacionado á intuição.',
      p4:
        'Isso espanta o pensamento obsessivo e as preocupações. A música pode ser um meio de calibração direta da energia: aumentando o pique quando é hora de entrar em ação e acalmando quando o momento pede isso. A linguagem do corpo também influencia as emoções. Em uma experiência bem conhecida, pediu-se a alguns atores que fizessem uma expressão de raiva. Depois, o grupo foi submetido a diversos testes psicológicos e exames para medir batimentos cardíacos, pressão sanguínea, temperatura, reação da pele e estímulos e níveis hormonais. Em seguida, os mesmos atores foram expostos a situações que os deixaram irritados de verdade e passaram de novo pelos mesmos testes.',
    },
    {
      p1:
      ...
      p2:
        'É por isso que instruímos nossos clientes para que ajam "como se", criando uma visão do lado de fora que desejam sentir do lado de dentro. Aristóteles dizia que você é aquilo que faz constantemente. A excelência não é um ato isolado, e sim um hábito.',
      p3:
        'É na intimidade dos relacionamentos que as emoções positivas e a recuperação de energia encontram um terreno fértil. Uma vida feliz em família ou uma noite agradável passada na companhia dos amigos proporcionam segurança e tranquilidade. E esses sentimentos estão intimamente associados à CID.',
      p4:
    ...
    {
      p1:
        'Mente em Alerta - o terceiro nível da pirâmide de desempenho - a capacidade mental - costuma ser o foco das atenções da maioria dos treinamentos voltados para o aperfeiçoamento do desempenho. Nosso objetivo é expandir as aptidões cognitivas dos clientes e sobretudo suas habilidades de concentração, organização do tempo e pensamento crítico.',
      p2:
  ...
  useEffect(() => {
    ...
    if (bloco === 1) i = texto1[1].p1.length - 350;
    if (bloco === 2) i = texto1[2].p1.length - 350;
    if (bloco === 3) i = texto1[3].p1.length;
    if (bloco === 4) i = texto1[4].p1.length - 250;
    if (bloco === 5) i = texto1[5].p1.length - 250;
    if (bloco === 6) i = texto1[6].p1.length;
    if (bloco === 7) i = texto1[7].p1.length - 400;
    if (bloco === 8) i = texto1[8].p1.length - 450;
    if (bloco === 9) i = texto1[9].p1.length - 400;
    if (bloco === 10) i = texto1[10].p1.length - 700;
